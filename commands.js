...
break;
case 3: message = message + user.name + ' Fell into the bandicams fream and noticed it wasnt pleasant.';
break;
...
break;
case 10: message = message + user.name + ' Got knocked out trying to fuck with ragequaza ';
break;
