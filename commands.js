...
break;
case 1: message = message + user.name + ' Took a hit of Bruno\'s joint and passed out';
break;
case 2: message = message + user.name + ' Got seduced by Sanguine and will come back in 5 min.';
break;
case 3: message = message + user.name + ' Fell into the bandicams d and noticed it wasnt pleasant.';
break;
case 4: message = message + user.name + ' Has been silenced by TalkTakesTime!';
break;        
case 5: message = message + user.name + ' Became  piiiikachuuu\'s slave!';
break;
case 6: message = message + user.name + ' Realized he was related to kupo and commited suicide!';
break;
case 7: message = message + user.name + ' Was found in a coffin in Brunoo\'s house.';
break;
case 8: message = message + user.name + ' Was hit by a spiritbolt!';
break;
case 9: message = message + user.name + ' Got fucked up by Weavile.';
break;
case 10: message = message + user.name + ' Got knocked out trying to fuck with a ragequaza ';
break;
case 11: message = message + user.name + ' Was knocked away by oiawesome when he was pissed off!';
break;
case 12: message = message + user.name + 'Tried snus and got cancer!';
break;
case 13: message = message + user.name + ' Saw Skalayle and left the server!';
break;
case 14: message = message + user.name + ' was hit by a banded out kyrem-b\'s outrage!';
break;
...
break;
case 17: message = message + 'Was forced to smell mrsmelly\'s feet!';
break;
...
break;
case 20: message = message + user.name + ' Was  attacked by nord and regice!';
break;
case 21: message = message + user.name + ' Took a bullet punch to the chest... and then one to the head.';
break;
case 22: message = message + user.name + ' Learned that bandicam secretly stole his girlfriend and runs out';
break;
case 23: message = message + user.name + ' Recieved bandirend from the almighty bandicam!';
break;
case 24: message = message + user.name + ' Was charmed by coolasian and ran out of love !';
break;
case 25: message = message + user.name + ' Pissed off a Gyarados!';
break;
case 26: message = message + user.name + ' Was taken away in Neko\'s black van!';
break;
case 27: message = message + user.name + ' Saw a moogle and hid under his covers.';
break;
case 28: message = message + user.name + ' Was Snaq-Attacked.';
break;
case 29: message = message + user.name + ' Was unfortunate and didn\'t get a cool message.';
break;
case 30: message = message + ' Has blacked out because of almost seeing Zact94\'s penis!';
break;
case 31: message = message + user.name + ' Was knocked out cold by Havinfun85!';
break;
case 32: message = message + user.name + ' Tried to hack tailz and was tossed through a window !';
break;
default: message = message + user.name + ' was  BandiHammered!';
};
message = message + ' ~~';
return message;
}
